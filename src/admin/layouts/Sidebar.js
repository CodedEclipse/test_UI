    ...
    <>
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <Accordion>
            <Accordion.Item eventKey="0" class="menu-item active open menu-link menu-toggle">
              <Accordion.Header class="text-truncate" ><i class="menu-icon tf-icons bx bx-home-smile"></i>Dashboards</Accordion.Header>
              <Accordion.Body class="menu-sub">
